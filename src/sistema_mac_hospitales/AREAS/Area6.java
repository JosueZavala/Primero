 ...
 * @author Alumno
 */
public class Area6 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Area6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
